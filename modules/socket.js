 ...
 */
export const socketSharePopoutMedia = async (
	url,
	players,
	title = '',
	loop = false,
	...
	return await socket.executeForUsers(
		'sharePopoutMedia',
		players,
		url,
		title,
 ...
 */
export const socketshareFullscreenMedia = async (
	url,
	players,
	type = 'image',
	title = '',
 ...
 */
const _socketshareFullscreenMedia = (
	url,
	type = 'image',
	title = '',
	immersive = false,
	...
	fullscreenLayer.handleShare(url, type, title, immersive, loop, mute, isNpc);
};
